...
# specified above.
shell("Rscript {snakemake.input.dupRScript} {snakemake.input.dupBAM} gtf={snakemake.input.GTF} stranded={snakemake.params.stranded} paired={snakemake.params.paired} outdir={snakemake.params.outdir}")
